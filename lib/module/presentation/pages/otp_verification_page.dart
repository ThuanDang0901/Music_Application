    ...
    try {
      ...
      if (mounted) {
        ToastHelper.showSuccess(
          context: context,
          message: widget.isSignUp
              ? 'Đăng ký và xác thực thành công!'
            ...
            children: [
              ...
              RichText(
                ...
                text: TextSpan(
                  ...
                  children: [
                    const TextSpan(
                      text: 'Chúng tôi đã gửi mã xác thực gồm 6 chữ số đến số điện thoại ',
                    ),
                    TextSpan(
                      text: _maskedPhone,
                      style: TextStyle(
              ...
              Center(
                child: TextButton.icon(
                  ...
                  icon: Icon(Icons.bug_report_outlined, size: 18, color: textColor.withValues(alpha: 0.4)),
                  label: Text(
